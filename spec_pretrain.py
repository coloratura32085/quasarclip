...
def parse_args():
    ...
    # 输出路径
    parser.add_argument('--log_dir', type=str, default=f'{ROOT_PATH}/outputs/spec/spec_g3_mask120/logs',
                        help="TensorBoard log directory")
    parser.add_argument('--output_dir', type=str, default=f'{ROOT_PATH}/outputs/spec/spec_g3_mask120',
...
def main():
    ...
    # 使用 Trainer 进行训练
    trainer.fit(model, train_loader, test_loader, ckpt_path='/home/kongxiao/data45/kx/dongbixin/outputs/spec/spec_g3_mask120/logs/lightning_logs/version_0/checkpoints/last.ckpt')
