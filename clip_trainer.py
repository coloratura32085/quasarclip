...
from models.clip import AstroClipModel
...
def parse_args():
    ...
    # 数据路径
    parser.add_argument('--train_data_path', type=str, default=f'{ROOT_PATH}/data/train_dataset',
                        help="Path to the training dataset")
    parser.add_argument('--test_data_path', type=str, default=f'{ROOT_PATH}/data/test_dataset',
    ...
    # 输出路径
    parser.add_argument('--log_dir', type=str, default=f'{ROOT_PATH}/outputs/astroclip/logs',
                        help="TensorBoard log directory")
    parser.add_argument('--output_dir', type=str, default=f'{ROOT_PATH}/outputs/astroclip',
                        help="Output directory for checkpoints")

    # 图像和光谱编码器权重路径
    parser.add_argument('--image_weight_path', type=str, default=f'{ROOT_PATH}/outputs/img/pths/_64/2000_0.75_0.001_0.05_64/best_loss.pth', help="Path to image encoder weights")
    parser.add_argument('--spec_weight_path', type=str, default=f'{ROOT_PATH}/last.ckpt', help="Path to spectrum encoder weights")
...
class ClipLightning(pl.LightningModule):
    def __init__(self, lr, weight_decay, T_max, T_warmup, image_weight_path, spec_weight_path):
        ...
        self.model = AstroClipModel(image_weight_path = image_weight_path, spec_weight_path=spec_weight_path)
...
def main():
    ...
    model = ClipLightning(lr=args.lr, weight_decay=args.weight_decay,
                          ...
                          image_weight_path=args.image_weight_path, spec_weight_path=args.spec_weight_path)
    ...
    trainer = pl.Trainer(
        ...
        callbacks=[
            ...
            #     min_delta=0.00,  # 最小改进阈值
            #     patience=10,  # 容忍没有改进的 epoch 数
            #     verbose=True,  # 是否打印日志
