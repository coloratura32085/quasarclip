...
# from models.clip_cross import AstroClipModel
...
#
#     # 数据路径
#     parser.add_argument('--train_data_path', type=str, default=f'D:/database/data_g3_z/train_dataset',
#                         help="Path to the training dataset")
#     parser.add_argument('--test_data_path', type=str, default=f'D:/database/data_g3_z/test_dataset',
...
#
#     # 输出路径
#     parser.add_argument('--log_dir', type=str, default=f'{ROOT_PATH}/outputs/clip/param_g3/logs',
#                         help="TensorBoard log directory")
#     parser.add_argument('--output_dir', type=str, default=f'{ROOT_PATH}/outputs/clip/param_g3',
#                         help="Output directory for checkpoints")
#
#     # 图像和光谱编码器权重路径
#     parser.add_argument('--spec_weight_path', type=str,
#                         default=f'D:/Desktop/epoch=227-step=128820.ckpt',
...
#         self.model = AstroClipModel(spec_weight_path=spec_weight_path,seq_input_size=120)
#
...
#
#     # 创建自定义数据集实例
#     train_dataset = PairDataset(train_dataset, transform=transform,probs=True)
#     test_dataset = PairDataset(test_dataset, transform=transform,probs=True)
#
#     # 创建 DataLoader
