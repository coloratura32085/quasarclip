...
class MaskedAutoencoderViTAE(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=8, in_chans=5,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False, kernel=1, mlp_hidden_dim=None):
        '''
...
def mae_vitae_base_patch8_dec192d4b(**kwargs):
    model = MaskedAutoencoderViTAE(
...
def mae_vitae_base_patch8_dec512d8b(**kwargs):
    model = MaskedAutoencoderViTAE(
...
mae_vitae_base_patch8 = mae_vitae_base_patch8_dec192d4b
mae_vitae_base_patch8_d8 = mae_vitae_base_patch8_dec512d8b# decoder: 512 dim, 8 blocks
